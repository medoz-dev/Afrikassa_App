...
const Header: React.FC = () => {
  ...
  return <header className="bg-primary text-white p-5 shadow-md">
      <div className="container mx-auto">
        <div className="flex flex-col md:flex-row justify-between items-center">
          ...
          {isInApp && <nav className="flex items-center space-x-1 md:space-x-4">
...
const NavLink: React.FC<NavLinkProps> = ({
  ...
  return <Link to={to} className="flex flex-col items-center px-2 py-1 rounded-md hover:bg-primary-foreground/10 transition-colors">
      {icon}
